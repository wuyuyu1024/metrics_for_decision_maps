## Code modified from https://github.com/LucaHermes/DeepView
...
class DeepView:
	...
	def update_matrix(self, old_matrix, new_values):
		...
		print(old_matrix.shape, new_mat.shape)
		# sns.heatmap(new_mat, )
		return new_mat + new_mat.transpose()
		# return new_values + new_values.transpose()
	...
	#### modified version of add_samples. ####
	def add_samples_new(self, samples, labels):
		'''
		This one does not compute the grids.
